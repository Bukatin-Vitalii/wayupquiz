...
const correctAnswer = document.getElementById("correct-answer"), //количество правильных ответов
  numberOfAllQuestions2 = document.getElementById("number-of-all-questions"), //количество всех вопросов (модальное окно)
  btnTryAgain = document.getElementById("btn-try-again"); //кнопка "начать викторину заново"

const questions = [
  {
    question: "В какой части Гарри Поттера воскресили Воландэморта?",
    options: [
      "Философский камень",
      "Кубок Огня",
      "Узник Аскабана",
  ...
  {
    question: "Японский автомобиль..",
    options: ["BMW", "Honda", "Peugeot", "Ford"],
    rightAnswer: 1,
  },
  {
    question: "Что такое Long Black?",
    options: [
      "Доппио с добавлением кипятка",
      "Американо с молоком",
